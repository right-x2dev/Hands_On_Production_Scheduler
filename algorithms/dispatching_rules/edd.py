...
#EDD스케줄러. solve()에 생산문제 넣으면 최종 스케줄 변환함. 
#입력: machines, jobs || 출력: schedule

#스케줄러 알고리즘(FJSP-EDD)
#EDD 기반 operation dispatching + earliest completion time기반 machine 할당.
...
class EDDScheduler:
    def solve(self, machines, jobs):
        ...
        while scheduled_count < total_operations:
            ...
            #후보 operation생성. EDD가 비교할 후보들을 담을 리스트. 
            candidates = []
            ...
            # Due Date가 가장 빠른 Job 선택
            #x[0]이 due date임. 
            # Due Date가 가장 빠른 Job의 operation들을 우선적으로 처리. 
